...
class ProxyHandler(BaseHTTPRequestHandler):
    ...
    def get_fetch_script(self, origin):
        return (
            ...
            'if(typeof i==="string"){'
            'if(i.indexOf(P)!==-1)return _f.call(this,i,n);'
            'var s=i;if(s.indexOf(location.origin)===0)s=O+s.substring(location.origin.length);'
            'return _f.call(this,p(s),n)'
            '}'
            'if(i&&i.url){'
            'var fu=i.url;'
            'if(fu.indexOf(P)!==-1)return _f.call(this,i,n);'
            'if(fu.indexOf(location.origin)===0)fu=O+fu.substring(location.origin.length);'
            'var r=new Request(p(fu),{method:i.method,body:i.body,headers:i.headers,credentials:i.credentials,mode:i.mode});'
            'return _f.call(this,r,n)'
            '}'
            'return _f.call(this,i,n)'
            '}'
            'var _o=XMLHttpRequest.prototype.open;'
            'XMLHttpRequest.prototype.open=function(m,u){'
            'if(typeof u==="string"&&u.indexOf(P)===-1){'
            'if(u.indexOf(location.origin)===0)u=O+u.substring(location.origin.length);'
            'arguments[1]=p(u)'
            '}'
