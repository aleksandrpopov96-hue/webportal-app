...
class ProxyHandler(BaseHTTPRequestHandler):
    ...
    def get_fetch_script(self, origin):
        return (
            ...
            '}'
            'if(i&&i.url){'
            'if(i.url.indexOf(P)!==-1)return _f.call(this,i,n);'
            'var r=new Request(p(i.url),{method:i.method,body:i.body,headers:i.headers,credentials:i.credentials,mode:i.mode});'
